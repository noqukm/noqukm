...
================================================== -->
  <body>
    ...
    <div class="row">
        <div class="col-lg-4">
        <div class="media">
            <a href="menu/"><img src="../public/images/nepali-momo.png" alt="nepali-momo"> </a>
        ...
        <div class="col-lg-4">
        <div class="media"><a href="menu/"><img src="../public/images/gorkha-special-chicken.png" alt="GURKHA SPECIAL CHICKEN"> </a>                        
        ...
        <div class="col-lg-4">
        <div class="media">
        <a href="menu/"><img src="../public/images/lam-tikka.png" alt="Lam Tikka"> </a>
