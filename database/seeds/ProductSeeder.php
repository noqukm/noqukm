...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('products')->insert([
           'name' => 'Chicken Bundle B - Regular (4-5 pax)',
           'description' => '2x McChicken®, 2x Spicy Chicken McDeluxe™, 9pcs Chicken McNuggets®, 4x French Fries - Medium, 4x Medium Coca-Cola®',
